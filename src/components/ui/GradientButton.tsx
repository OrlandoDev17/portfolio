...
export default function GradientButton({ href, children, className }: Buttons) {
  return (
    <a
      className={`flex w-fit items-center gap-3 px-4 py-3 rounded-lg text-sm 2xl:text-base font-medium text-white bg-gradient-to-r from-blue-500 via-violet-500 to-violet-700
