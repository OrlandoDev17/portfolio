...
export function LanguageIcon({ className }: IconProps) {
  return (
    <svg
      ...
      className={`lucide lucide-languages-icon lucide-languages ${className}`}
    >
      <path d="m5 8 6 6" />
...
export function BriefcaseIcon({ className }: IconProps) {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={`lucide lucide-briefcase-business-icon lucide-briefcase-business ${className}`}
    >
      <path d="M12 12h.01" />
...
export function FileDonwIcon({ className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={`lucide lucide-file-down-icon lucide-file-down ${className}`}
    >
...
export function ActivyIcon({ className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={`lucide lucide-activity-icon lucide-activity ${className}`}
    >
...
export function RokectIcon({ className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export function PuzzleIcon({ className }: IconProps) {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={`lucide lucide-puzzle-icon lucide-puzzle ${className}`}
    >
...
export function NotebookIcon({ className }: IconProps) {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={`lucide lucide-notebook-pen-icon lucide-notebook-pen ${className}`}
    >
...
export function RulerIcon({ className }: IconProps) {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={`lucide lucide-ruler-icon lucide-ruler ${className}`}
    >
...
export function RightLineIcon({ className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={`lucide lucide-move-right-icon lucide-move-right ${className}`}
    >
...
export function Venezuela({ className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="32"
...
export function USA({ className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="32"
