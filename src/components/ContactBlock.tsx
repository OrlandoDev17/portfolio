      ...
      >
        <article className="flex flex-col items-center justify-center bg-white dark:bg-slate-900 p-6 rounded-xl">
          <div className="flex flex-col justify-center items-center gap-6 m-8">
            <h2 className="text-2xl md:text-3xl dark:text-white font-semibold">
              ¿Listo para trabajar juntos?
            </h2>
            <p className="text-gray-600 dark:text-gray-300 max-w-130 text-center md:text-lg">
          ...
          <hr className="max-w-220 text-gray-400 mb-8" />
